...
enum ButtonType
{
	...
	MIN_MAX_BUTTON,		 //最大化及关闭按钮
	QNLY_CLOSE_BUTTON    //只有关闭按钮
};
//自定义标题栏
...
private:
	...
	ButtonType m_buttonType;		//标题栏右上角按钮内型
};

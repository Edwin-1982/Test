...
Cmfctest2Dlg::Cmfctest2Dlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(Cmfctest2Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &Cmfctest2Dlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &Cmfctest2Dlg::OnBnClickedButton2)
	ON_BN_CLICKED(IDC_BTN3, &Cmfctest2Dlg::OnClickedBtn3)
END_MESSAGE_MAP()
...
void Cmfctest2Dlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
	MessageBox(_T("大家好!"));
...
void Cmfctest2Dlg::OnClickedBtn3()
{
	// TODO: 在此添加控件通知处理程序代码

	MessageBox(_T("wwwwwwwwwww"));

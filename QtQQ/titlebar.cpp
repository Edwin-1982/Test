...
void TitleBar::initControl()
{
	...
	mylayout->setSpacing(0);                  //设置布局里不见间的间隙
...
void TitleBar::initConnections()
{
	...
	connect(m_pButtonClose, SIGNAL(clicked()), this, SLOT(onButtonMaxClicked()));
}
...
void TitleBar::paintEvent(QPaintEvent* event)
{
	...
	//当窗口最大化或还原后,窗口长度改变,标题栏响应作出改变
	//parentWigeWidget()返回父部件

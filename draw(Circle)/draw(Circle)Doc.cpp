...
// draw(Circle)Doc.cpp: CdrawCircleDoc 类的实现
//
...
CdrawCircleDoc::CdrawCircleDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CdrawCircleDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CdrawCircleDoc::InitializeSearchContent()
{
...
void CdrawCircleDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{

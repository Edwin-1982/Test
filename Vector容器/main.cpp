...
void demo1() {
	...
	cout << "v1的大小: " << v1.capacity() << endl;

	//当我么能使用vector的默认构造函数时,切记不能通过下标去访问
	//v1[0] = 1;
	...
	*/
	...
	//v2.assign(2,888);//第一种方法 改变原来vector中的元素个数
	//v2.assign(v3.begin(), v3.end());//第二种方法,使用迭代器赋值
	int test1[] = { 1,2,3,4,5 };
	//v2.assign(test1, test1 + 3);//第三种方法,使用指针赋值
	v2 = v3;
	cout << "v2调用 assign后: " << endl;
	cout << "v2的元素个数: " << v2.size() << endl;
	cout << "v2中存储的元素是: " << endl;
